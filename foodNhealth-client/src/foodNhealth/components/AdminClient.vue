<template>
  <b-modal title="Διαχείριση Χρήστη" id="adminClientModal" v-model="visible" :no-close-on-backdrop="true"
      ...
      <div class="row">
        ...
        <div class="col-6">
          ...
          <b-form-group description="Εισάγετε το όνομα" :feedback="errors.first('firstName')"
            ...
            <b-input-group>
              ...
              <b-form-input name="firstName" type="text" placeholder="Όνομα" v-model="client.firstName"
          ...
          <b-form-group description="Εισάγετε το επώνυμο" :feedback="errors.first('lastName')"
            ...
            <b-input-group>
              ...
              <b-form-input name="lastName" type="text" placeholder="Επώνυμο" v-model="client.lastName"
          ...
          <b-form-group description="Εισάγετε τη διεύθυνση Email" :feedback="errors.first('email')"
            ...
            <b-input-group>
              ...
              <b-form-input name="email" type="email" placeholder="Email" v-model="client.email"
          ...
          <b-form-group description="Εισάγετε το συνθηματικό εισόδου (εφόσον επιθυμείτε να το θέσετε/αλλάξετε)"
            ...
            <b-input-group>
              ...
              <b-form-input name="password" type="password" placeholder="Συνθηματικό Χρήστη" v-model="client.password"
        ...
        <div class="col-6">
          <b-form-group label="Ενεργός" :feedback="errors.first('isActive')" :state="isValid('isActive')"
                        :horizontal="true">
            <b-input-group>
              <b-form-checkbox name="isActive" v-model="client.isActive" v-validate="rules.isActive"
          ...
          <b-form-group description="Συμπληρώστε προαιρετικά σχόλια" :feedback="errors.first('comments')"
            ...
            <b-input-group>
              ...
              <b-form-textarea name="comments" placeholder="Σχόλια" v-model="client.comments"
...
<script src="./AdminClientVM.js"></script>
