<template>
  <b-modal title="Διαχείριση Κατηγορίας Λιπιδίων" id="lipidTypeModal" v-model="visible" :no-close-on-backdrop="true" :no-close-on-esc="true">
...
<script src="./LipidTypeVM.js"></script>
