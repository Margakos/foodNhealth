<template>
  <b-modal title="Διαχείριση Κατηγορίας Λοιπών" id="otherNutrientTypeModal" v-model="visible" :no-close-on-backdrop="true" :no-close-on-esc="true">
      ...
      <b-form-group description="Εισάγετε τον τίτλο"
        ...
        <b-input-group>
          ...
          <b-form-input name="title" type="text" placeholder="Τίτλος"
                        v-model="otherNutrientType.title"
      ...
      <b-form-group description="Εισάγετε την περιγραφή"
        ...
        <b-input-group>
          ...
          <b-form-input name="description" type="text" placeholder="Περιγραφή"
                        v-model="otherNutrientType.description"
...
<script src="./OtherNutrientTypeVM.js"></script>
