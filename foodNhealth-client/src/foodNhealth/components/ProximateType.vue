<template>
  <b-modal title="Διαχείριση Κατηγορίας Θρεπτικών Συστατικών" id="proximateTypeModal" v-model="visible" :no-close-on-backdrop="true" :no-close-on-esc="true">
      ...
      <b-form-group description="Εισάγετε την περιγραφή"
        ...
        <b-input-group>
          ...
          <b-form-input name="description" type="text" placeholder="Περιγραφή"
                        v-model="proximateType.description"
...
<script src="./ProximateTypeVM.js"></script>
