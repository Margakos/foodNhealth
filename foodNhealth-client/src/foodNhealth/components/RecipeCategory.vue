<template>
  <b-modal title="Διαχείριση Κατηγορίας Συνταγών" id="recipeCategoryModal" v-model="visible" :no-close-on-backdrop="true" :no-close-on-esc="true">
          ...
          <b-form-group description="Εισάγετε την περιγραφή"
            ...
            <b-input-group>
              ...
              <b-form-input name="description" type="text" placeholder="Περιγραφή"
                            v-model="recipeCategory.description"
...
<script src="./RecipeCategoryVM.js"></script>
