<template>
  <b-modal title="Διαχείριση Supermarket" id="supermarketModal" v-model="visible" :no-close-on-backdrop="true" :no-close-on-esc="true">
...
<script src="./SupermarketVM.js"></script>
