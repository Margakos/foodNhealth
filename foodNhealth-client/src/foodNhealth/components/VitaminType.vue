<template>
  <b-modal title="Διαχείριση Κατηγορίας Βιταμινών" id="vitaminTypeModal" v-model="visible" :no-close-on-backdrop="true" :no-close-on-esc="true">
      ...
      <b-form-group description="Εισάγετε την περιγραφή"
        ...
        <b-input-group>
          ...
          <b-form-input name="description" type="text" placeholder="Περιγραφή"
                        v-model="vitaminType.description"
...
<script src="./VitaminTypeVM.js"></script>
